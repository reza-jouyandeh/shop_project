...
// این اسلایدرها (books-slider, featured-slider, ...) فقط توی صفحه‌ی اصلی وجود دارن.
// چون همین فایل js توی همه‌ی صفحه‌های سایت لود می‌شه (محصول، سبد خرید و ...)،
// اول چک می‌کنیم المنت مربوطه روی صفحه هست یا نه، تا روی صفحه‌های دیگه ارور نده.
